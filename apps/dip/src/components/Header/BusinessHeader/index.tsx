...
const BusinessHeader = () => {
  ...
  const businessSiderHidden = useGlobalLayoutStore(
    (s) => s.businessSiderHidden,
  );
  ...
  const breadcrumbMode = (location.state as { breadcrumbMode?: string } | null)
    ?.breadcrumbMode;
  const isInitialConfigOnlyMode =
    currentRoute?.key === "initial-configuration" &&
    breadcrumbMode === "init-only";
