  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        // page: {
        //   type: "component",
        //   componentKey: "agent-square",
        // },
        // children: [
        //   {
        //     key: "agentList",
        //     label: "决策智能体",
        //     path: buildBusinessNetworkPath("/agent-list"),
        //     page: {
        //       type: "micro-app",
        //       app: {
        //         name: "agent-list",
        ...
        //     key: "agentTemplate",
        //     label: "模板",
        //     path: buildBusinessNetworkPath("/agent-template"),
        //     page: {
        //       type: "micro-app",
        //       app: {
        //         name: "agent-template",
        ...
        //     key: "agentApi",
        //     label: "API",
        //     path: buildBusinessNetworkPath("/agent-api"),
        //     page: {
        //       type: "micro-app",
        //       app: {
        //         name: "agent-api",
...
const flattenLeafItems = (items: BusinessMenuItem[]): BusinessMenuLeafItem[] =>
  items.flatMap((item) =>
    "children" in item ? flattenLeafItems(item.children) : item,
  );

export const businessLeafMenuItems: BusinessMenuLeafItem[] =
  flattenLeafItems(businessMenuItems);
...
const findAncestorKeysByPath = (
  ...
  for (const item of items) {
    if ("children" in item) {
      const found = findAncestorKeysByPath(item.children, pathname, [
        ...parentKeys,
        item.key,
      ]);
      if (found.length > 0) {
